...
function getData() {
  var timNguoiDung = document.getElementById("tim-user").value.toLowerCase();
  for (let i = 0; i < zodiacs.length; i++) {
    const zodiac = zodiacs[i];
    if (timNguoiDung === zodiac.name.toLocaleLowerCase()) {
      document.getElementById("img").src = zodiac.image;
      document.getElementById("ket-qua-tim").innerHTML = zodiac.description;
    }
  }
}
